    ...
    div.innerHTML = `
        ...
        <div class="rule-content">
            ...
            <datalist id="productList">
                <option value="Alexa" />
                <option value="Alexa for Business" />
                <option value="Alexa Top Sites" />
                <option value="Alexa Web Information Service" />
                <option value="AlexaForBusiness" />
                <option value="AlexaTopSites" />
                ...
                <option value="Amazon Bedrock AgentCore" />
                <option value="Amazon Budgets" />
                <option value="Amazon Chime" />
                <option value="Amazon Chime CallMe" />
                <option value="Amazon Chime Dialin" />
                <option value="Amazon Chime Features" />
                <option value="Amazon Cloud Directory" />
                ...
                <option value="Amazon Cognito Sync" />
                <option value="Amazon Comprehend" />
                <option value="Amazon Comprehend Medical" />
                <option value="Amazon Connect" />
                <option value="Amazon Connect Customer Profiles" />
                <option value="Amazon DataZone" />
                <option value="Amazon Detective" />
                <option value="Amazon DevOps Guru" />
                <option value="Amazon DocumentDB" />
                ...
                <option value="Amazon EC2 Container Service" />
                <option value="Amazon EC2 Reserved Instances Marketplace" />
                <option value="Amazon EKS Anywhere" />
                ...
                <option value="Amazon Elastic Inference" />
                <option value="Amazon Elastic MapReduce" />
                <option value="Amazon Elastic Transcoder" />
                <option value="Amazon Elasticsearch Service" />
                <option value="Amazon Forecast" />
                <option value="Amazon Fraud Detector" />
                <option value="Amazon FSx" />
                <option value="Amazon GameLift" />
                ...
                <option value="Amazon IVS" />
                <option value="Amazon Kendra" />
                <option value="Amazon Keyspaces" />
                ...
                <option value="Amazon Kinesis Video Streams" />
                ...
                <option value="Amazon WorkSpaces Application Manager" />
                <option value="Amazon WorkSpaces Applications" />
                <option value="Amazon WorkSpaces Thin Client" />
                <option value="Amazon WorkSpaces Web" />
                <option value="Amazon Zocalo" />
                <option value="AmazonCloudWatch" />
                <option value="AmazonContactLens" />
                <option value="AmazonDataExchange" />
                <option value="AmazonForecast" />
                <option value="AmazonFraudDetector" />
                <option value="AmazonIVS" />
                <option value="AmazonKeyspacesforApacheCassandra" />
                <option value="AmazonPersonalize" />
                <option value="AmazonWorkMail" />
                <option value="Amplify" />
                <option value="APIGateway" />
                <option value="APN Annual Program Fee" />
                <option value="ApnAnnualFee" />
                <option value="ApplicationDiscoveryService" />
                <option value="AppStream" />
                <option value="AppSync" />
                <option value="Athena" />
                <option value="AutoScaling" />
                <option value="AWS Amplify" />
                <option value="AWS App Runner" />
                <option value="AWS AppFabric" />
                <option value="AWS Application Discovery Service" />
                <option value="AWS Application Migration Service" />
                <option value="AWS AppSync" />
                <option value="AWS Audit Manager" />
                <option value="AWS Auto Scaling" />
                <option value="AWS Backup" />
                <option value="AWS Batch" />
                ...
                <option value="AWS Elastic Disaster Recovery" />
                <option value="AWS Elemental" />
                <option value="AWS Elemental MediaConnect" />
                <option value="AWS Elemental MediaConvert" />
                <option value="AWS Elemental MediaLive" />
                <option value="AWS Elemental MediaPackage" />
                <option value="AWS Elemental MediaStore" />
                <option value="AWS Elemental MediaTailor" />
                <option value="AWS End User Messaging" />
                <option value="AWS Fargate" />
                <option value="AWS Fault Injection Simulator" />
                <option value="AWS Firewall Manager" />
                <option value="AWS Global Accelerator" />
                <option value="AWS Glue" />
                <option value="AWS Greengrass" />
                <option value="AWS HealthImaging" />
                <option value="AWS Identity and Access Management Access Analyzer" />
                <option value="AWS Import/Export" />
                <option value="AWS Import/Export Snowball" />
                <option value="AWS IoT" />
                <option value="AWS IoT 1 Click" />
                <option value="AWS IoT Analytics" />
                <option value="AWS IoT Core" />
                <option value="AWS IoT Device Defender" />
                <option value="AWS IoT Device Management" />
                <option value="AWS IoT Events" />
                <option value="AWS IoT SiteWise" />
                <option value="AWS IoT TwinMaker" />
                <option value="AWS Key Management Service" />
                <option value="AWS Lambda" />
                <option value="AWS Lambda (Preview)" />
                <option value="AWS Managed Service Program Audit" />
                <option value="AWS Media Connect" />
                <option value="AWS Migration Hub" />
                <option value="AWS Migration Hub Refactor Spaces" />
                <option value="AWS Network Firewall" />
                <option value="AWS OpsWorks" />
                <option value="AWS Outposts" />
                <option value="AWS Payment Cryptography" />
                <option value="AWS Premium Support" />
                <option value="AWS Professional Services" />
                <option value="AWS re:Invent Ticket" />
                <option value="AWS Resilience Hub" />
                <option value="AWS RoboMaker" />
                <option value="AWS Route 53 Application Recovery Controller" />
                <option value="AWS Secrets Manager" />
                <option value="AWS Security Hub" />
                <option value="AWS Sentinel" />
                <option value="AWS Sentinel Beta" />
                <option value="AWS Service Catalog" />
                <option value="AWS Shield" />
                <option value="AWS Skill Builder Individual" />
                <option value="AWS Snowball" />
                <option value="AWS Snowball Extra Days" />
                <option value="AWS Step Functions" />
                <option value="AWS Storage Gateway" />
                <option value="AWS Storage Gateway Deep Archive" />
                <option value="AWS Support" />
                <option value="AWS Support (Business)" />
                <option value="AWS Support (Developer)" />
                <option value="AWS Support (Enterprise)" />
                <option value="AWS Support (FP Partner Led)" />
                <option value="AWS Systems Manager" />
                <option value="AWS Telco Network Builder" />
                <option value="AWS Training" />
                <option value="AWS Training Credits" />
                <option value="AWS Transfer Family" />
                <option value="AWS Transfer for SFTP" />
                <option value="AWS Transform" />
                <option value="AWS WAF" />
                <option value="AWS X-Ray" />
                <option value="AWSContactLens" />
                <option value="AWSDataExchange" />
                <option value="AWSDevOpsAgent" />
                <option value="AWSDetective" />
                <option value="AWSKeyspaces" />
                <option value="AWSPersonalize" />
                <option value="Backup" />
                <option value="Batch" />
                <option value="Blockchain" />
                <option value="Budgets" />
                <option value="BusinessSupport" />
                <option value="CertificateManager" />
                <option value="CertificateMgr" />
                <option value="Chime" />
                <option value="ChimeCallMe" />
                <option value="ChimeDialin" />
                <option value="CloudDirectory" />
                <option value="CloudFront" />
                <option value="CloudHSM" />
                <option value="CloudMap" />
                <option value="CloudSearch" />
                <option value="CloudTrail" />
                <option value="CloudWatch" />
                <option value="CloudWatchEvents" />
                <option value="CodeBuild" />
                <option value="CodeCommit" />
                <option value="CodeDeploy" />
                <option value="CodePipeline" />
                <option value="CodeStar" />
                <option value="Cognito" />
                <option value="CognitoSync" />
                <option value="Comprehend" />
                <option value="Comprehend Medical" />
                <option value="ComprehendMedical" />
                <option value="ComputeSavingsPlans" />
                <option value="Config" />
                <option value="Connect" />
                <option value="Contact Lens" />
                <option value="Contact Lens for Amazon Connect" />
                <option value="ContactCenterTelecomm" />
                <option value="Contact Center Telecommunications (service sold by AMCS" />
                <option value="CostExplorer" />
                <option value="Data Exchange" />
                <option value="DatabaseMigration" />
                <option value="DataPipeline" />
                <option value="DataSync" />
                <option value="DataTransfer" />
                <option value="DAX" />
                <option value="DBMigration" />
                <option value="DBS" />
                <option value="Detective" />
                <option value="DeveloperSupport" />
                <option value="DeviceFarm" />
                <option value="DirectConnect" />
                <option value="DirectoryService" />
                <option value="DocDB" />
                <option value="DocumentDB" />
                <option value="DynamoDB" />
                <option value="DynamoDB Accelerator (DAX)" />
                <option value="DynamoDB Reserved Capacity" />
                <option value="DynamoDBAccelerator" />
                <option value="EC2" />
                <option value="EC2RIMarketplace" />
                <option value="ECR" />
                <option value="ECS" />
                <option value="ECS for Kubernetes" />
                <option value="ECS4K" />
                <option value="ECSKubernetes" />
                <option value="EFS" />
                <option value="EKS" />
                <option value="Elastic Load Balancing" />
                <option value="ElastiCache" />
                <option value="ElasticFileSystem" />
                <option value="ElasticInference" />
                <option value="ElasticSearch" />
                <option value="ElasticTranscoder" />
                <option value="Elemental" />
                <option value="ElementalMediaConnect" />
                <option value="ElementalMediaConvert" />
                <option value="ElementalMediaLive" />
                <option value="ElementalMediaPackage" />
                <option value="ElementalMediaStore" />
                <option value="ElementalMediaTailor" />
                <option value="EMR" />
                <option value="EnterpriseSupport" />
                <option value="Fargate" />
                <option value="Firehose" />
                <option value="FirewallManager" />
                <option value="FMS" />
                <option value="Forecast" />
                <option value="FPSupport" />
                <option value="FraudDetector" />
                <option value="FSx" />
                <option value="Gamelift" />
                <option value="Glacier" />
                <option value="GlobalAccel" />
                <option value="GlobalAccelerator" />
                <option value="Glue" />
                <option value="GreenGrass" />
                <option value="GuardDuty" />
                <option value="ImportExport" />
                <option value="ImportExportSnowball" />
                <option value="Inspector" />
                <option value="InternetOfThings" />
                <option value="IoT" />
                <option value="IoT1Click" />
                <option value="IoTAnalytics" />
                <option value="IoTCore" />
                <option value="IoTDeviceDefender" />
                <option value="IoTDeviceManagement" />
                <option value="IoTDeviceMgmt" />
                <option value="KafkaStreaming" />
                <option value="KeyManagementService" />
                <option value="Kinesis" />
                <option value="KinesisAnalytics" />
                <option value="KinesisFirehose" />
                <option value="KinesisVideo" />
                <option value="KinesisVideoStreams" />
                <option value="KMS" />
                <option value="Lambda" />
                <option value="LambdaPreview" />
                <option value="Lex" />
                <option value="Lightsail" />
                <option value="MachineLearning" />
                <option value="Macie" />
                <option value="ManagedBlockchain" />
                <option value="Marketplace" />
                <option value="MediaConnect" />
                <option value="MigrationHub" />
                <option value="ML" />
                <option value="MobileAnalytics" />
                <option value="MQ" />
                <option value="MSK" />
                <option value="MSPA" />
                <option value="Neptune" />
                <option value="NetworkFirewall" />
                <option value="OCBAmazonRoute53" />
                <option value="OCBAWS Shield" />
                <option value="OCBAWSShield" />
                <option value="OCBCloudFront" />
                <option value="OCBVMware Cloud on AWS" />
                <option value="OpenSearch" />
                <option value="OpsWorks" />
                <option value="Personalize" />
                <option value="Pinpoint" />
                <option value="Polly" />
                <option value="PremiumSupport" />
                <option value="ProfessionalServices" />
                <option value="ProServ" />
                <option value="QuickSight" />
                <option value="RDS" />
                <option value="Redshift" />
                <option value="Registrar" />
                <option value="ReInvent" />
                <option value="Rekognition" />
                <option value="RoboMaker" />
                <option value="Route 53 Domain Registration Service" />
                <option value="Route53" />
                <option value="Route53DRS" />
                <option value="S3" />
                <option value="SageMaker" />
                <option value="Savings Plans for AWS Compute usage" />
                <option value="SavingsPlans" />
                <option value="SecretsManager" />
                <option value="SecretsMgr" />
                <option value="SecurityHub" />
                <option value="Sentinel" />
                <option value="ServiceCatalog" />
                <option value="SES" />
                <option value="SFTPTransfer" />
                <option value="Shield" />
                <option value="SimpleDB" />
                <option value="SimpleEmailService" />
                <option value="SimpleWorkflowService" />
                <option value="Snowball" />
                <option value="SnowballExtraDays" />
                <option value="SnowballImportExport" />
                <option value="SNS" />
                <option value="SQS" />
                <option value="StepFunctions" />
                <option value="StorageGateway" />
                <option value="StreamingForKafka" />
                <option value="Sumerian" />
                <option value="Support" />
                <option value="SupportBusiness" />
                <option value="SupportDeveloper" />
                <option value="SupportEnterprise" />
                <option value="SWS" />
                <option value="SystemsManager" />
                <option value="Textract" />
                <option value="Training" />
                <option value="Transcribe" />
                <option value="Transfer4SFTP" />
                <option value="TransferForSFTP" />
                <option value="Translate" />
                <option value="VPC" />
                <option value="WAF" />
                <option value="WAM" />
                <option value="WorkDocs" />
                <option value="Workflow" />
                <option value="WorkMail" />
                <option value="WorkSpaces" />
                <option value="WorkspacesAppMgr" />
                <option value="X-Ray" />
                <option value="XRay" />
                <option value="Zocalo" />
            </datalist>
